...
# ==========================================
print("Cargando modelo de embeddings semánticos para SVR...")
...
def entrenar_modelo_svr(X, y):
    ...
    print("Entrenando regresor SVR (Kernel RBF)...")
    # C=20 e epsilon=0.1 para permitir flexibilidad sin subajustar
    ...
    print("\n=============================================")
    print("         MÉTRICAS DE EVALUACIÓN SVR          ")
    print("=============================================")
    print(f"R² Score (Precisión General) : {r2:.4f}")
    print(f"RMSE (Margen de Error)       : {rmse:.4f}%")
    print("=============================================")
    
    os.makedirs("modelos_entrenados/svr", exist_ok=True)
    joblib.dump(model, "modelos_entrenados/svr/pivipp_svr.pkl")
    joblib.dump(scaler, "modelos_entrenados/svr/pivipp_svr_scaler.pkl")
