...
# ==========================================
print("Cargando modelo de embeddings semánticos para SVR V3...")
...
def calcular_metricas_ranking(df_eval, score_corte_relevancia=70.0, k=3):
    """
    Calcula Precision@K, Recall@K, MRR y NDCG@K controlando dinámicamente el tamaño de los vectores.
    """
    ...
    for _, group in grupos:
        ...
        actual_k = len(rel_k)  # Ajuste dinámico ante submuestras menores a K
...
# ==========================================
# 6. ENTRENAMIENTO Y EVALUACIÓN SVR
# ==========================================
def entrenar_modelo_svr(X, df_interacciones):
    ...
    # Métricas de ranking / recomendación
    ...
    print("\n=============================================")
    print("         MÉTRICAS DE EVALUACIÓN SVR V3        ")
    print("=============================================")
    print("--- Regresión ---")
    ...
    # Guardar artefactos
    os.makedirs("../modelos_entrenados/svr3", exist_ok=True)
    joblib.dump(model, "../modelos_entrenados/svr3/pivipp_svr.pkl")
    joblib.dump(scaler, "../modelos_entrenados/svr3/pivipp_svr_scaler.pkl")
    print("¡Modelo SVR V3 guardado exitosamente!")
...
if __name__ == "__main__":
    ...
    if os.path.exists(path_dataset):
        ...
        entrenar_modelo_svr(X, df_interacciones)
    else:
