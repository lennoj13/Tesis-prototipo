...
export default function RegisterPage() {
  ...
  function validate() {
    ...
    } else if (formData.role === 'estudiante' && !formData.email.toLowerCase().endsWith('@ug.edu.ec')) {
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="button"
                  onClick={() => setFormData(prev => ({ ...prev, role: 'empresa' }))}
                  className={`flex-1 py-3 px-4 rounded-xl border-2 text-sm font-medium transition-all ${
            ...
            <div>
              <Input
                ...
                name="email"
                type="email"
                placeholder={formData.role === 'estudiante' ? 'tucorreo@ug.edu.ec' : 'correo@empresa.com'}
