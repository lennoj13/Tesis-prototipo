...
export default function AdminDashboard() {
  ...
  const mainCards = [
    { label: 'Estudiantes registrados', value: stats?.total_students, icon: FiUser, color: 'from-blue-500 to-blue-600', bg: 'bg-blue-50', text: 'text-blue-600' },
    { label: 'Empresas registradas', value: stats?.total_companies, icon: FiBriefcase, color: 'from-amber-500 to-amber-600', bg: 'bg-amber-50', text: 'text-amber-600' },
    { label: 'Vacantes activas', value: stats?.total_vacancies, icon: FiFileText, color: 'from-green-500 to-green-600', bg: 'bg-green-50', text: 'text-green-600' },
    { label: 'Total postulaciones', value: stats?.total_applications, icon: FiTarget, color: 'from-purple-500 to-purple-600', bg: 'bg-purple-50', text: 'text-purple-600' },
  ];

  const detailCards = [
    { label: 'Postulaciones pendientes', value: stats?.pending_applications, icon: FiClock, bg: 'bg-amber-50', text: 'text-amber-600' },
    { label: 'Postulaciones aprobadas', value: stats?.approved_applications, icon: FiCheckCircle, bg: 'bg-green-50', text: 'text-green-600' },
    { label: 'Empresas por aprobar', value: stats?.pending_companies, icon: FiAlertCircle, bg: 'bg-red-50', text: 'text-red-600' },
  ];
